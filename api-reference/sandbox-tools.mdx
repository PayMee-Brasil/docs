...
<Card
  ...
  icon="user-plus"
  href="https://sandbox.paymee.com.br/register"
>
  Click here to access the Sandbox registration page and create your test account.
</Card>

## Simulating Pix Automatic

The Sandbox includes a simulator that drives the full Pix Automatic recurrence lifecycle (authorize, charge, settle, fail and cancel) without a real payer.

<Card
  title="Testing Pix Automatic in Sandbox"
  icon="flask"
  href="/api-reference/test-pix-automatic-in-sandbox"
>
  Drive mandates, collections, run-due charges, scenarios and reason codes end to end.
</Card>